...
from paths import ESSAY, INDEX, SITE_ROOT

# The homepage is not long-form, but it links across the site (including to the
# dashboard), and those edges are worth the same check.
FILES = [ESSAY, INDEX]
